 ...
 * 
 * Handling of entries in "current medication list" with no other data than current medications could be as follows:
 * - SubstanceAdministrationEvent with documentationTime = time when snapshot was taken of current medication list, administrationEventTime = null if no data provided on when medication was started or stopped, administrationTime with specified Low but null High if data only provided on when medication was started.
 * 
 * To specify "patient takes an unknown drug", use a code for substance that represents "unknown medication".
 * 
 * <p>Java class for SubstanceAdministrationEvent complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="doseNumber" type="{org.opencds.vmr.v1_0.schema.datatypes}INT" minOccurs="0"/>
 ...
 *         &lt;element name="informationAttestationType" type="{org.opencds.vmr.v1_0.schema.datatypes}CD" minOccurs="0"/>
 *         &lt;element name="isValid" type="{org.opencds.vmr.v1_0.schema.datatypes}BL" minOccurs="0"/>
...
@XmlType(name = "SubstanceAdministrationEvent", propOrder = {
    ...
    "documentationTime",
    "informationAttestationType",
    "isValid",
    "relatedEntity",
    "relatedClinicalStatement"
})
public class SubstanceAdministrationEvent
    extends SubstanceAdministrationBase
{
     ...
     *     
     */
    public void setIsValid(BL value) {
        this.isValid = value;
    }
