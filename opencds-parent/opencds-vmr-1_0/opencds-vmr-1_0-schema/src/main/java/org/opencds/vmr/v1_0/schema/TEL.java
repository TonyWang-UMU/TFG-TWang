 ...
 *       &lt;attribute name="use" type="{org.opencds.vmr.v1_0.schema.datatypes}set_TelecommunicationAddressUse" />
 *       &lt;attribute name="capabilities" type="{org.opencds.vmr.v1_0.schema.datatypes}set_TelecommunicationCapability" />
 *       &lt;attribute name="useablePeriodOriginalText" type="{http://www.w3.org/2001/XMLSchema}string" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "TEL", namespace = "org.opencds.vmr.v1_0.schema.datatypes")
public class TEL
    extends ANY
{
    ...
    @XmlAttribute(name = "useablePeriodOriginalText")
    ...
    /**
     * Sets the value of the useablePeriodOriginalText property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
