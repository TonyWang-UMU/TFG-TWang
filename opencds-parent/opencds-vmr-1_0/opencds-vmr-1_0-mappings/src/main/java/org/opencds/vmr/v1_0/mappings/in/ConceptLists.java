...
/* Supply */
	...
	public List<SupplyUndeliveredReasonConcept> 		supplyUndeliveredReasonConceptList			= Collections.synchronizedList(new ArrayList<SupplyUndeliveredReasonConcept>());
...
//    		clinicalStatementEntityInRoleRelationshipConceptList.clear();
    	...
    	/* Supply */
    		...
    		supplyUndeliveredReasonConceptList.clear();
