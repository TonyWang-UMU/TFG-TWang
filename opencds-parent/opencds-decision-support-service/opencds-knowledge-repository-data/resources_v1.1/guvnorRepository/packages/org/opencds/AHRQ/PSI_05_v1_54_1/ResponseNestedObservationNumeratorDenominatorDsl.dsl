[then] Response.Nested.Obs.Num.Denom - Create numerator value {numValue} as ID {numId} and denominator value {denomValue} as ID {denomId} for output observations focused on {ResponseObservationFocus:ENUM:ObservationFocusConcept.openCdsConceptCode} within enclosing observation ID {ROOT} = 
...
childObs{numId}Focus.setCode("{ResponseObservationFocus}"); 
childObs{numId}Focus.setDisplayName(GetOpenCDSConceptName("{ResponseObservationFocus}")); 
...
childObs{denomId}Focus.setCode("{ResponseObservationFocus}"); 
childObs{denomId}Focus.setDisplayName(GetOpenCDSConceptName("{ResponseObservationFocus}")); 
...
insert(rel{denomId}); 
namedObjects.put("rel{denomId}", rel{denomId}); 
//ResponseNestedObservationDenomNumDsl|||denomValue=={denomValue}|||denomId=={denomId}|||numValue=={numValue}|||numId=={numId}|||ROOT=={ROOT}|||ResponseObservationFocus=={ResponseObservationFocus}